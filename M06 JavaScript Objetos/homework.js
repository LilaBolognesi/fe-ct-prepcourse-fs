...
function invocarMetodo(objeto, metodo) {
   ...
   // if (objeto.hasOwnProperty(metodo) && metodo.tipeof === 'function');
   // objeto[metodo]();
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var likesTotales=0;//variable auxiliar para guardar todo el contenido de las diferentes sumas que vamos a hacer
   //iteramos sobre cada una de las posiciones que tiene el array
   for ( var i=0; i < objetoUsuario.posts.length; i ++){
      likesTotales= likesTotales + objetoUsuario.posts[i].likes
// sumamos la propiedad likes dentro de cada uno de estos elementos que tiene el array
   }
   return likesTotales;
